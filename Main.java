...
2.) Superclass: We should have two private String variables for name and color. Then our constructor can accept two Strings and assign them to our variables. Finally, we should have the functions getName(), setName(), getColor(), and setColor(). We can also have a paint() function that creates a drawing, and a toString() to be overwritten later.
...
5.) We will override the paint() function to match the pen type and width or the paint texture. We also override toString to reflect if the object is specifically pen or paint.
 */
